		...
		<script>
		 ...
		 <!-- Form -->
			<form id="registration_form" action="contact.php" method="post">
				...
				<div>
					<label>
						<input placeholder="email地址:" type="email" tabindex="3" required>
					</label>
				</div>
				<div class="sky-form">
					<div class="sky_form1">
				...
				<div>
					<label>
						<input placeholder="重复密码" type="password" tabindex="4" required>
					</label>
				</div>	
				<div>
					<input type="submit" value="创建帐户" id="register-submit">
				</div>
				<div class="sky-form">
					<label class="checkbox"><input type="checkbox" name="checkbox" ><i></i>我同意购物条款 &nbsp;<a class="terms" href="#"> 购物服务</a> </label>
				</div>
			</form>
			<!-- /Form -->
		</div>
